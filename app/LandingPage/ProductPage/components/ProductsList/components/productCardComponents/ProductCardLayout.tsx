...
const ProductCardLayout = ({ data }: Props) => {
    ...
    return (
        <>
            {/* desktop layout */}
            <div className='border-b border-black/5 hidden md:flex items-center p-4 hover:bg-gray-50 transition-colors'>
                <div className='w-[7%]'>
            ...
            <div className='border border-black/15 bg-white p-2 flex md:hidden rounded my-1 flex-col gap-2 relative'>
                <div className='flex w-full justify-between items-start'>
                    ...
                    <div className='flex items-center justify-between'>
                        {data.value == null ? <div className={`w-max  rounded-[10px]  flex justify-center items-center px-2 py-[2px]`}>
                            <Label className='text-[9px] flex items-center justify-center'>No Promotion</Label>
                        </div> :
                            <div className={`${data.promotion_type == 'FlashSale' ? 'bg-[#FFD477] text-white' : 'bg-[#FF7777] text-white'} w-max  rounded-[10px]  flex justify-center items-center px-2 py-[2px]`}>
                                <Label className='text-[11px] flex items-center justify-center'>{data.promotion_type}</Label>
                            </div>}
                ...
                <div className='w-full gap-2 items-start flex'>
                    <div>
                        <Image
                            ...
                            height={100}
                            alt=''
                            className='w-[100px] border border-white/10 rounded h-[100px]' />
                    </div>
                    <div className='flex flex-col items-start gap-[2px]'>
                        <Label className='font-thin text-[10px]'>{data.brand}</Label>
                        <Label className='font-semibold'>{data.product_name}</Label>
                        <div className='flex items-center gap-1'>
                            <Label className='font-thin w-full'>{new Intl.NumberFormat('en-PH', {
                                style: 'currency',
                                currency: 'PHP',
                        ...
                        <div className=' flex items-center gap-1'>
                            <RiStackLine className='text-[13px]' />
                            <Label className='font-thin'>{data.stocks}</Label>
                            <Label className='font-thin'>Remaining</Label>
                        </div>
                        <Label className='font-thin'>{data.sales_count} sold</Label>
                    </div>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <Dialog>
                                <form>
                                    ...
                                    <DialogContent className="w-[95vw] max-w-lg rounded-[10px]">
                                        <DialogHeader>
                                            <DialogTitle>Edit Stocks</DialogTitle>
                                            <DialogDescription>
                                                Make changes to product stocks here. Click save when you&apos;re
