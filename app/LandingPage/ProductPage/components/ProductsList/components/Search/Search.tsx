        ...
        <div className='w-full relative'>
            ...
            <div className={` bg-[#F1F0EE] max-h-[50vh] overflow-auto mt-1 rounded w-full absolute z-50  flex-col ${searchResults.length != 0 ? 'flex' : 'hidden'}`}>
                <div className='flex bg-white text-black p-1 rounded-t sticky top-0 border-b border-black/30'>
                    ...
                    <Label className='text-[11px] w-[20%]'>Status</Label>
                </div>
                <div className='flex flex-col gap-1 p-1'>
                    {searchResults.map((data, index) => (
                        <div key={index} className='flex items-center bg-[#FFFFFF] text-black shadow-sm'>
                            <div className='flex items-center  rounded  cursor-pointer  w-[45%]'>
                            ...
                            <Label className='text-[13px] w-[10%] font-thin'>{data.stocks}</Label>
