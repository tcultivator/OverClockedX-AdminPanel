...
const Total_orders_card = () => {
    ...
    return (
        <div className={`${cardDisplaySwitcher ? 'flex-1' : 'hidden md:flex'} p-3 md:p-7  flex-col md:flex-row bg-white items-center gap-3 justify-start rounded border border-black/15 h-full w-full md:px-4 border border-black/15`}>
