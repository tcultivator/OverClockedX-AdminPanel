...
const Total_orders_card = () => {
    ...
    return (
        <div className={`${cardDisplaySwitcher ? 'flex' : 'hidden md:flex'} p-3 md:p-7  flex-col md:flex-row bg-white items-center gap-3 justify-start rounded   h-max w-full md:px-4 `}>
            ...
            <div className='flex items-center justify-start w-full gap-1'>
                <div className='flex gap-1 items-center w-full '>
                    <div className='bg-[#104254]/70 flex justify-center items-center p-1 md:p-2.5 rounded-[50%]'>
